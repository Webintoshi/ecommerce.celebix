...
try {
  for(const width of [1280,390,320]) {
    ...
    let mode='unsent', failOnce=true, recordVersion=1, editBehavior='none'; const editSaves=[];
    ...
    evidence.push({width,stableRetry:true,stableSourceSaveRetry:true,editConflictRebased:true,convertedConflictLocked:true,unknownConflictLocked:true,unknownNotUnsent:true,readonlyConverted:true,saveOnly:true,inputPreserved:true,keyboard:true,overflow:false,pageErrors:errors});await context.close();
  }
