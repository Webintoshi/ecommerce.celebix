...
export function DesignFixFixture({ workspace }: { workspace: StorefrontDesignWorkspace }) {
  ...
  return <PanelLayoutClient model={model}>
    ...
    <DesignWorkspace workspace={workspace} canManage recoveryScope="isolated-design-qa-session-store" />
  </PanelLayoutClient>;
}
