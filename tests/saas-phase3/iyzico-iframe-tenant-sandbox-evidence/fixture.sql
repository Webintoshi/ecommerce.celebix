...
INSERT INTO saas.principals(
  ...
  'https://id.test','iyzico-evidence-owner','iyzico-evidence@test.invalid',true,
...
INSERT INTO saas.stores(
  ...
  ('10000000-0000-4000-8000-000000000060','Iyzico Evidence A','iyzico-evidence-a',
   'active','tr','TRY','default','2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z'),
  ('10000000-0000-4000-8000-000000000061','Iyzico Evidence B','iyzico-evidence-b',
   'active','tr','TRY','default','2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z');

INSERT INTO saas.memberships(
  id,principal_id,store_id,role,status,created_at,updated_at
) VALUES
  ('30000000-0000-4000-8000-000000000060','20000000-0000-4000-8000-000000000060',
   '10000000-0000-4000-8000-000000000060','store_owner','active',
   '2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z'),
  ('30000000-0000-4000-8000-000000000061','20000000-0000-4000-8000-000000000060',
...
INSERT INTO saas.subscriptions(
  ...
  ('31000000-0000-4000-8000-000000000060','10000000-0000-4000-8000-000000000060',
   ...
   '2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z'),
...
-- Test-only simulation of platform approval. Migration 060 must never write this table.
INSERT INTO saas.merchant_provider_execution_authorities(
  ...
  ('iyzico_iframe','payment_processing','test',7,
   ...
   'sandbox_ready',true,'2026-07-28T13:00:00.000Z'),
...
INSERT INTO saas.merchant_provider_profiles(
  ...
  ('40000000-0000-4000-8000-000000000060','10000000-0000-4000-8000-000000000060',
   ...
   repeat('1',64),'provider.current',1,1,'active',1,'2026-07-28T13:00:00.000Z',
   NULL,NULL,NULL,'2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z',NULL,
  ...
  ('40000000-0000-4000-8000-000000000061','10000000-0000-4000-8000-000000000061',
   ...
   '{"algorithm":"A256GCM","ciphertext":"AQ","iv":"AAAAAAAAAAAAAAAA","keyId":"provider.current","tag":"AAAAAAAAAAAAAAAAAAAAAA","version":1}',
   repeat('2',64),'provider.current',1,1,'active',1,'2026-07-28T13:00:00.000Z',
   NULL,NULL,NULL,'2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z',NULL,
   NULL,NULL,NULL,'test',7),
  ('40000000-0000-4000-8000-000000000062','10000000-0000-4000-8000-000000000060',
   'paytr_iframe','payment_processing','{"environment":"test"}','paytr test',
   '{"algorithm":"A256GCM","ciphertext":"AQ","iv":"AAAAAAAAAAAAAAAA","keyId":"provider.current","tag":"AAAAAAAAAAAAAAAAAAAAAA","version":1}',
   repeat('3',64),'provider.current',1,1,'active',1,'2026-07-28T13:00:00.000Z',
   NULL,NULL,NULL,'2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z',NULL,
...
INSERT INTO saas.payment_methods(
  ...
  ('50000000-0000-4000-8000-000000000060','10000000-0000-4000-8000-000000000060',
   'provider','40000000-0000-4000-8000-000000000060','iyzico_iframe','Iyzico',
   'disabled',NULL,0,'{"environment":"test"}',1,'2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z'),
  ('50000000-0000-4000-8000-000000000061','10000000-0000-4000-8000-000000000061',
   ...
   'disabled',NULL,0,'{"environment":"test"}',1,'2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z'),
  ('50000000-0000-4000-8000-000000000062','10000000-0000-4000-8000-000000000060',
   'provider','40000000-0000-4000-8000-000000000062','paytr_iframe','PayTR',
   'disabled',NULL,1,'{"environment":"test"}',1,'2026-07-28T13:00:00.000Z','2026-07-28T13:00:00.000Z');
