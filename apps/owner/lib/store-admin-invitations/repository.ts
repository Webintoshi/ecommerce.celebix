...
export interface InvitationAuthorization { deliveryId: string; invitationId: string; storeId: string; generation: number; attemptCount: number; leaseExpiresAt: string; expiresAt: string }
