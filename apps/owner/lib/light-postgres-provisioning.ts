    ...
    gateways: [
      {
        ...
        requiredAction: "Banka hesap bilgileri ve onay akisi admin panelinden tamamlanmali.",
      },
      {
        id: "cod",
        key: "cod",
...
VALUES
  (
    ...
    ${toSqlJsonLiteral({ bankAccounts: [] })},
    'Banka hesap bilgileri ve onay akisi admin panelinden tamamlanmali.'
  ),
  (
    'cod',
    'Kapida Odeme',
