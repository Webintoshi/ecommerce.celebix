...
-- Migration 040 is additive. Remove only the seven disposable record kinds before restoring 039 exactly.
...
DELETE FROM saas.merchant_admin_operations
 WHERE result_payload->>'kind' IN('seo_geo_profile','seo_internal_link','seo_content_entry','seo_category_entry','seo_page_entry','seo_product_entry','ai_setting');
DELETE FROM saas.merchant_admin_events
 WHERE record_kind IN('seo_geo_profile','seo_internal_link','seo_content_entry','seo_category_entry','seo_page_entry','seo_product_entry','ai_setting');
DELETE FROM saas.merchant_admin_records
 WHERE record_kind IN('seo_geo_profile','seo_internal_link','seo_content_entry','seo_category_entry','seo_page_entry','seo_product_entry','ai_setting');
...
REVOKE ALL ON FUNCTION saas.merchant_admin_setting_public_path(jsonb),saas.merchant_admin_setting_uuid(jsonb),saas.merchant_admin_setting_locale(jsonb)
...
DROP FUNCTION saas.merchant_admin_setting_locale(jsonb);
DROP FUNCTION saas.merchant_admin_setting_uuid(jsonb);
DROP FUNCTION saas.merchant_admin_setting_public_path(jsonb);
