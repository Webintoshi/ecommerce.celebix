...
BEGIN
  IF pg_catalog.current_setting(
      'celebix.allow_storefront_hosted_checkout_read_only_authority_down',true
    )<>'on'
  THEN RAISE EXCEPTION 'STOREFRONT_HOSTED_CHECKOUT_READ_ONLY_AUTHORITY_DOWN_GUARD_REQUIRED'; END IF;
END
$f$;
