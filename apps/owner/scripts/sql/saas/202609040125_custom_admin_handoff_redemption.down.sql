-- EMERGENCY, PRE-RESTORE ONLY: reinstate the prior canonical-host-only policy.
BEGIN;
...
AS $custom_admin_handoff_redemption_rollback$
DECLARE
...
BEGIN
  ...
  RETURN QUERY SELECT 'redeemed'::text, issued_authority;
END
$custom_admin_handoff_redemption_rollback$;
