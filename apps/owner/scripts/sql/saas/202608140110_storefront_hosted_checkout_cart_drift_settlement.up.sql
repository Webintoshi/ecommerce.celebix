...
BEGIN
  IF routine_oid IS NULL THEN
    RAISE EXCEPTION 'STOREFRONT_HOSTED_CHECKOUT_CART_DRIFT_SETTLEMENT_PREREQUISITE_MISSING';
  END IF;
  IF NOT EXISTS(
    ...
    WHERE procedure.oid=routine_oid
      ...
      AND pg_catalog.md5(procedure.prosrc) IN(
        '6d848daf71a4ae8c1e0cc60c5af3e3c0',
        '2136fc918e9b3c427016e74f68eaa9b2'
      )
  ) THEN
    RAISE EXCEPTION 'STOREFRONT_HOSTED_CHECKOUT_CART_DRIFT_SETTLEMENT_SOURCE_CHANGED';
  END IF;
END
$f$;
