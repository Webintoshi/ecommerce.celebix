-- Restore the public category order from before manual merchandising.
BEGIN;
SET LOCAL ROLE celebix_saas_owner;
SET LOCAL lock_timeout='5s';
SET LOCAL statement_timeout='120s';

CREATE OR REPLACE FUNCTION saas.public_list_products_by_category(p_store_id uuid,p_hostname text,p_now timestamptz,p_slug text,p_limit integer)
