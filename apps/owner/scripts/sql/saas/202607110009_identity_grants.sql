...
GRANT SELECT, INSERT, UPDATE, DELETE ON saas.registration_workflows TO celebix_saas_identity;
GRANT SELECT, INSERT, UPDATE, DELETE ON saas.oidc_transactions TO celebix_saas_identity;
