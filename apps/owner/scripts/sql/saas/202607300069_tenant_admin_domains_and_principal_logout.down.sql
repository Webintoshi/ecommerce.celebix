...
DROP FUNCTION saas.redeem_cross_host_panel_handoff(text,text,text,timestamptz);
DROP FUNCTION saas.issue_cross_host_panel_handoff(text,text,uuid,uuid,text,text,uuid,text,uuid,uuid,uuid,text,text,timestamptz,timestamptz,timestamptz);
