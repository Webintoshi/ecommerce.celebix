...
BEGIN
  ...
  IF NOT saas.promotion_rule_document_valid(pg_catalog.jsonb_build_object('schemaVersion',1,'benefit',pg_catalog.jsonb_build_object('kind','free_shipping'),'targets','{}'::jsonb,'audience','{}'::jsonb,'trigger','{}'::jsonb,'schedule','{}'::jsonb,'limits','{}'::jsonb,'conditions','{}'::jsonb,'combinationPolicy','{}'::jsonb,'priority',0,'marginPolicy','{}'::jsonb,'progressMessagePolicy','{}'::jsonb)) THEN RAISE EXCEPTION 'PROMOTIONS_STUDIO_RULE_VALIDATOR_INVALID'; END IF;
