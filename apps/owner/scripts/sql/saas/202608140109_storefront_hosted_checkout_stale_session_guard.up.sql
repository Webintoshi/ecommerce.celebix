...
BEGIN
  IF routine_oid IS NULL THEN
    RAISE EXCEPTION 'STOREFRONT_HOSTED_CHECKOUT_STALE_SESSION_GUARD_PREREQUISITE_MISSING';
  END IF;
  IF NOT EXISTS(
    ...
    WHERE procedure.oid=routine_oid
      ...
      AND pg_catalog.md5(procedure.prosrc)='92223a7e62e59230082d02dc6bdc0a0d'
  ) THEN
    RAISE EXCEPTION 'STOREFRONT_HOSTED_CHECKOUT_STALE_SESSION_GUARD_SOURCE_CHANGED';
  END IF;
END
$f$;
