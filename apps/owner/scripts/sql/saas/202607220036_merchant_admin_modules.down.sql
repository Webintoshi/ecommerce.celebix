...
DROP FUNCTION saas.merchant_admin_record_event(uuid,uuid,uuid,text,jsonb,timestamptz);
DROP FUNCTION saas.merchant_admin_recover_operation(uuid,uuid,uuid,uuid,text,bigint,timestamptz,uuid,text);
DROP FUNCTION saas.merchant_admin_archive(uuid,uuid,uuid,uuid,text,bigint,timestamptz,uuid,text,uuid,bigint);
...
DROP FUNCTION saas.merchant_admin_event_projection(uuid,uuid);
DROP FUNCTION saas.merchant_admin_mutation_projection(uuid,text,text,bigint,timestamptz);
...
DROP TABLE saas.merchant_admin_records;
DROP FUNCTION saas.guard_merchant_admin_immutable();
