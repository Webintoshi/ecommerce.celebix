...
test("abandoned-cart staging migration installs only wholly absent layers and verifies every layer", async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "-- 202608140105_storefront_checkout_returning_customer_identity.up.sql",
      "-- 202608140105_storefront_checkout_returning_customer_identity_assertions.sql",
  ...
  assert.deepEqual(lines, [
    ...
    "abandoned_cart_migration_checkout_returning_customer_identity=applied",
