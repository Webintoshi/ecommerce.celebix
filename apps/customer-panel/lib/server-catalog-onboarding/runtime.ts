...
const METHODS = Object.freeze([
  ...
  "listCategories", "reorderCategories", "getCategoryProductOrder", "reorderCategoryProducts", "createCategory", "updateCategory", "archiveCategory", "getCategoryDeletionImpact", "deleteCategory",
] as const);
...
function facade(repository: CatalogOnboardingRepository): CatalogOnboardingRepository {
  ...
  const selected: CatalogOnboardingRepository = {
    ...
    reorderCategories: (input) => repository.reorderCategories(input),
    getCategoryProductOrder: (input) => repository.getCategoryProductOrder(input),
    reorderCategoryProducts: (input) => repository.reorderCategoryProducts(input),
