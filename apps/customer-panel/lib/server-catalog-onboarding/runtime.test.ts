...
test("approved access resolves only the frozen onboarding facade", () => {
  ...
  assert.deepEqual(Object.keys(runtime.onboarding).sort(), ["archiveCategory", "createCategory", "createProduct", "deleteCategory", "getCategoryDeletionImpact", "getCategoryProductOrder", "getOptions", "getProductEditor", "listCategories", "publishAfterMedia", "reorderCategories", "reorderCategoryProducts", "updateCategory", "updateMerchandising"]);
