...
const PATH = new RegExp(`^(?:/api/catalog/onboarding/(?:options|products|categories(?:/${UUID}(?:/(?:archive|deletion-impact|delete|product-order))?)?)|/api/catalog/products/${UUID}/(?:merchandising|publish-after-media))$`);
