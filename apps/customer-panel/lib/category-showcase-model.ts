...
export function buildCategoryShowcaseConfig(value: Readonly<{
  ...
  if (typeof value !== "object" || value === null || typeof value.heading !== "string" || typeof value.enabled !== "boolean" || !Array.isArray(value.rows)) invalid();
  ...
  return Object.freeze({ heading, enabled: value.enabled, items: Object.freeze(items) });
}
