...
test("customer handoff approval is sealed, disabled, and limited to disposable or approved staging", () => {
...
test("copied, serialized, spread, cloned, and plain customer approvals lose authority", () => {
