...
function field(
  ...
  return Object.freeze({ key, label, type, ...(placeholder ? { placeholder } : {}), ...(allowedValues ? { allowedValues: Object.freeze([...allowedValues]) } : {}), ...(optionLabels ? { optionLabels: Object.freeze({ ...optionLabels }) } : {}), ...(maxItems === undefined ? {} : { maxItems }), ...(required ? { required } : {}) });
}
