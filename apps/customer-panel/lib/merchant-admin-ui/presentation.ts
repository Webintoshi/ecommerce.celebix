...
export const MERCHANT_MODULE_DEFINITIONS = Object.freeze([
  ...
  definition({ kind: "seo_control", cardinality: "singleton", family: "seo", route: "/seo", title: "SEO Kontrol", singular: "SEO profili", description: "Mağaza arama görünürlüğü ve varsayılan meta alanlarını yönetin.", fields: [field("metaTitle", "Meta başlık"), field("metaDescription", "Meta açıklama", "textarea"), field("allowIndex", "İndekslemeye izin ver", "boolean")] }),
  definition({ kind: "sitemap", cardinality: "singleton", family: "seo", route: "/seo/sitemap", title: "Site Haritası", singular: "site haritası profili", description: "Site haritasına dahil edilen içerik ailelerini yönetin.", fields: [field("includeProducts", "Ürünleri dahil et", "boolean"), field("includeContent", "İçerikleri dahil et", "boolean"), field("changeFrequency", "Güncelleme sıklığı")] }),
  definition({ kind: "social_preview", cardinality: "singleton", family: "seo", route: "/seo/social-preview", title: "Sosyal Önizleme", singular: "sosyal önizleme", description: "Paylaşım başlığı, açıklaması ve görselini yönetin.", fields: [field("title", "Başlık"), field("description", "Açıklama", "textarea"), field("imageUrl", "Görsel URL", "url")] }),
