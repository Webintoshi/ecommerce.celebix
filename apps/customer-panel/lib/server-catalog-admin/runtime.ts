...
const METHODS = Object.freeze(["listResources", "getResource", "saveResource", "archiveResource", "listReviews", "moderateReview", "listImports", "importProducts", "prepareImport", "getImportPreview", "commitImportPreview"] as const);
