...
const METHODS = Object.freeze(["listResources", "saveResource", "archiveResource", "listReviews", "moderateReview", "listImports", "importProducts", "importProductsV2", "authorizeFeedPreview"] as const);
