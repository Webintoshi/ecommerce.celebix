...
const METHODS = Object.freeze(["listResources", "saveResource", "archiveResource", "listReviews", "moderateReview", "listImports", "importProducts", "prepareImport", "getImportPreview", "commitImportPreview"] as const);
