...
test("shipping runtime is registered once for approved panel access", () => {
  ...
  assert.ok(runtime);
  assert.deepEqual(Object.keys(runtime.admin), ["current", "setup", "saveConnection", "selectResources", "revokeConnection", "beginQuote", "currentQuote", "beginShipment", "currentShipment", "currentShipmentForOrder", "beginShipmentAction", "currentShipmentLabel"]);
  assert.deepEqual(Object.keys(runtime.workflow), ["claimValidation", "openClaimedCredential", "completeValidation", "failValidation", "claimFulfillment", "openFulfillment", "completeQuote", "failFulfillment", "completeShipment", "markShipmentUnknown", "claimShipmentAction", "openShipmentAction", "completeShipmentAction", "failShipmentAction", "markShipmentActionUnknown"]);
