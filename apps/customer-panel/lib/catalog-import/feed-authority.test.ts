...
test("only globally routable IPv4 and IPv6 addresses may back a feed host", () => {
  ...
  for (const address of ["0.0.0.0", "10.0.0.1", "100.64.0.1", "127.0.0.1", "169.254.1.1", "172.16.0.1", "192.168.1.1", "224.0.0.1", "::", "::1", "fc00::1", "fe80::1", "2001::1", "2001:2::1", "2001:10::1", "2001:20::1", "2001:db8::1", "2002:7f00:1::1", "3fff::1", "::ffff:127.0.0.1", "invalid"]) assert.equal(isPublicCatalogFeedAddress(address), false, address);
});
