...
async function authorize(dependencies: Dependencies, request: Request, method: "GET" | "POST" | "PATCH", pathname: string): Promise<Response | Authorized> {
