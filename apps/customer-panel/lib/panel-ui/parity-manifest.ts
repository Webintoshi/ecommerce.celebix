...
function entry(donorPath: string, targetPath: string, status: DonorParityStatus, authority: DonorParityAuthority): DonorParityEntry {
  return Object.freeze({ donorPath, targetPath, status, authority });
}
...
export const HEMENAKU_DONOR_PARITY = Object.freeze([
  ...
  entry("/ayarlar/bildirimler", "/settings/notifications", "route_depth", "merchant_admin"),
  entry("/ayarlar/dil", "/settings/language", "complete", "merchant_admin"),
  entry("/ayarlar/genel", "/settings/general", "complete", "merchant_admin"),
  entry("/ayarlar/hero-banner", "/settings/hero-banner", "route_depth", "merchant_admin"),
  entry("/ayarlar/kargo", "/settings/shipping", "complete", "merchant_admin"),
  entry("/ayarlar/marquee", "/settings/marquee", "route_depth", "merchant_admin"),
  entry("/ayarlar/odeme", "/settings/payment", "complete", "merchant_admin"),
  entry("/ayarlar/odeme/[id]/duzenle", "/settings/payment/[recordId]/edit", "route_depth", "merchant_admin"),
  entry("/ayarlar/odeme/yeni", "/settings/payment/new", "route_depth", "merchant_admin"),
  entry("/ayarlar/promosyon-banner", "/settings/promotion-banner", "route_depth", "merchant_admin"),
  entry("/ayarlar/tasarim", "/settings/design", "route_depth", "merchant_admin"),
  ...
  entry("/cms/blog/[id]", "/content/blog/[recordId]/edit", "route_depth", "merchant_admin"),
  entry("/cms/blog/yeni", "/content/blog/new", "route_depth", "merchant_admin"),
  entry("/cms/politikalar", "/content/policies", "complete", "merchant_admin"),
  entry("/cms/politikalar/[slug]", "/content/policies/[recordId]/edit", "route_depth", "merchant_admin"),
  entry("/cms/sayfalar", "/content/pages", "complete", "merchant_admin"),
  entry("/cms/sayfalar/[id]", "/content/pages/[recordId]/edit", "route_depth", "merchant_admin"),
  entry("/cms/sayfalar/yeni", "/content/pages/new", "route_depth", "merchant_admin"),
  entry("/indirimler", "/discounts", "complete", "merchant_admin"),
  entry("/indirimler/[id]/duzenle", "/discounts/[recordId]/edit", "route_depth", "merchant_admin"),
  ...
  entry("/musteriler/[id]/duzenle", "/customers/[customerId]/edit", "route_depth", "customers"),
  ...
  entry("/seo-killer/geo-optimizasyon", "/seo/geo-optimization", "route_depth", "merchant_admin"),
  entry("/seo-killer/hizli-index", "/seo/fast-indexing", "provider_gated", "merchant_admin"),
  entry("/seo-killer/ic-linkleme", "/seo/internal-linking", "route_depth", "merchant_admin"),
  entry("/seo-killer/icerikler", "/seo/content", "route_depth", "merchant_admin"),
  entry("/seo-killer/kategoriler", "/seo/categories", "route_depth", "merchant_admin"),
  entry("/seo-killer/kod-entegrasyonlari", "/seo/code-integrations", "complete", "merchant_admin"),
  entry("/seo-killer/sayfalar", "/seo/pages", "route_depth", "merchant_admin"),
  ...
  entry("/seo-killer/urunler", "/seo/products", "route_depth", "merchant_admin"),
  entry("/siparisler", "/orders", "complete", "orders"),
  entry("/siparisler/[id]", "/orders/[orderId]", "complete", "orders"),
  entry("/siparisler/[id]/yazdir", "/orders/[orderId]/print", "route_depth", "orders"),
  ...
  entry("/urunler/barkod-etiketleri", "/products/barcode-labels", "route_depth", "catalog_admin"),
  entry("/urunler/ekstralar", "/products/extras", "complete", "catalog_admin"),
  entry("/urunler/ekstralar/[id]", "/products/extras/[resourceId]/edit", "route_depth", "catalog_admin"),
  entry("/urunler/ekstralar/[id]/onizleme", "/products/extras/[resourceId]/preview", "route_depth", "catalog_admin"),
  entry("/urunler/ekstralar/yeni", "/products/extras/new", "route_depth", "catalog_admin"),
  entry("/urunler/etiketler", "/products/tags", "route_depth", "catalog_admin"),
  entry("/urunler/fiyat-listeleri", "/products/price-lists", "route_depth", "catalog_admin"),
  entry("/urunler/koleksiyonlar", "/products/collections", "complete", "catalog_admin"),
  entry("/urunler/koleksiyonlar/[id]/duzenle", "/products/collections/[resourceId]/edit", "route_depth", "catalog_admin"),
  entry("/urunler/koleksiyonlar/yeni", "/products/collections/new", "route_depth", "catalog_admin"),
  ...
  entry("/urunler/nitelikler/[id]/duzenle", "/products/attributes/[resourceId]/edit", "route_depth", "catalog_admin"),
  entry("/urunler/nitelikler/yeni", "/products/attributes/new", "route_depth", "catalog_admin"),
  entry("/urunler/otomatik-yukle", "/products/auto-import", "route_depth", "catalog_admin"),
  entry("/urunler/satin-alma", "/products/purchasing", "route_depth", "catalog_admin"),
  entry("/urunler/shopify-donusturucu", "/products/shopify-converter", "route_depth", "catalog_admin"),
  entry("/urunler/stok-sayimi", "/products/inventory-counts", "route_depth", "catalog_admin"),
  ...
  entry("/urunler/transferler", "/products/transfers", "route_depth", "catalog_admin"),
