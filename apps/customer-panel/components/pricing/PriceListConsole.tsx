...
import { buildPriceListIntent, canAddPricingRule, createPricingMutationController, createPricingRequestLifecycle, pricingApi, pricingErrorState, pricingRuleDraft, type PricingErrorState, type PricingRuleDraft } from "@/lib/pricing-ui/client";
...
function PriceListEditor(props: Readonly<{ resourceId?: string; canManage: boolean }>) {
  ...
  useEffect(() => { const cleanup = lifecycle.setup(); return () => { cleanup(); mutations.dispose(); }; }, [lifecycle, mutations]);
