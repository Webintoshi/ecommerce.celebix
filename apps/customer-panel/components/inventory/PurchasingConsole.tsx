...
export function PurchasingListPresentation(props: Readonly<{ state: InventoryListPhase; items: readonly PurchaseOrder[]; error: string; onRetry: () => void }>) {
...
export function PurchasingDetailPresentation(props: Readonly<{ state: InventoryConsoleSnapshot<PurchaseOrder>; canManage: boolean; onOrder: () => void; onReceive: () => void; onCancel: () => void }>) {
