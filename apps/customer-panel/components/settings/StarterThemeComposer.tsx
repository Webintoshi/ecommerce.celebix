      ...
      <div className={styles.editor}>
        ...
        {activePanel === "visual" ? <fieldset className={styles.panel} disabled={disabled}>
          ...
          <div className={styles.fieldGrid}>
            ...
            <label>Header<select value={state.visual.headerStyle} onChange={(event) => patch({ visual: { ...state.visual, headerStyle: event.currentTarget.value as StarterThemeEditorState["visual"]["headerStyle"] } })}><option value="overlay">Banner üzerinde (şeffaf)</option><option value="solid">Banner dışında (düz zemin)</option></select></label>
            ...
            <label>Header yerleşimi<select value={state.visual.headerLayout} onChange={(event) => patch({ visual: { ...state.visual, headerLayout: event.currentTarget.value as StarterThemeEditorState["visual"]["headerLayout"] } })}><option value="centered">Ortalı klasik</option><option value="logo_left">Logo solda</option><option value="logo_top">Logo üstte, menü altta</option><option value="menu_top">Menü üstte, logo altta</option></select></label>
            <label>Logo boyutu<select value={state.visual.logoSize} onChange={(event) => patch({ visual: { ...state.visual, logoSize: event.currentTarget.value as StarterThemeEditorState["visual"]["logoSize"] } })}><option value="small">Küçük</option><option value="medium">Orta</option><option value="large">Büyük</option><option value="xlarge">Çok büyük</option></select></label>
            <label>Logo hizası<select value={state.visual.logoAlignment} onChange={(event) => patch({ visual: { ...state.visual, logoAlignment: event.currentTarget.value as StarterThemeEditorState["visual"]["logoAlignment"] } })}><option value="left">Sola yasla</option><option value="center">Ortala</option></select></label>
