...
export default function CheckoutPage() {
  ...
  const handleCompleteOrder = async () => {
    ...
    if (!customerAuthMigrationRequired && !user && createAccount) {
    ...
    try {
      ...
      const orderData = {
        ...
        notes: !customerAuthMigrationRequired && createAccount ? "Hesap oluşturuldu" : "",
        contactEmail,
        receiveUpdates: true,
        createAccount: !customerAuthMigrationRequired && !user && createAccount,
      ...
      toast.success(!customerAuthMigrationRequired && createAccount
