      ...
      <div className="min-h-[60vh] bg-gradient-to-br from-[#FFF5F5] to-[#FFE5E5] px-4 py-16">
        <div className="mx-auto max-w-2xl rounded-3xl bg-white p-8 shadow-sm ring-1 ring-black/5">
          <h1 className="text-3xl font-semibold tracking-tight text-neutral-900">
            Hızlı ödeme bağlantısı geçici olarak devre dışı
          </h1>
          <p className="mt-4 text-base leading-7 text-neutral-600">
            DeryCraft için light Postgres hazırlığı sırasında hızlı ödeme bağlantıları geçici olarak kapatıldı.
            Siparişinizi standart ödeme adımından misafir olarak tamamlayabilirsiniz.
          </p>
