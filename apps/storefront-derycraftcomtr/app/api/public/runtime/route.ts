...
export async function GET() {
  ...
  return NextResponse.json({
    ...readRuntime(),
    databaseMode: disconnectRuntime.databaseMode,
    customerAuthStatus: disconnectRuntime.customerAuthStatus,
    reviewsStatus: disconnectRuntime.reviewsStatus,
    abandonedCartStatus: disconnectRuntime.abandonedCartStatus,
    quickOrderStatus: disconnectRuntime.quickOrderStatus,
    analyticsStatus: disconnectRuntime.analyticsStatus,
    couponStatus: disconnectRuntime.couponStatus,
