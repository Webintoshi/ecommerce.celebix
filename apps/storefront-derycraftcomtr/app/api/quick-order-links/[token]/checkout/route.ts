...
import {
  ...
  isStorefrontQuickOrderDisabled,
...
export async function POST(
  ...
  if (isStorefrontQuickOrderDisabled()) {
    return NextResponse.json(
      {
        success: false,
        code: DERYCRAFT_TEMPORARILY_DISABLED_CODE,
        reason: DERYCRAFT_REQUIRES_LIGHT_POSTGRES_SUPPORT_CODE,
        error: "Hizli siparis linki odemesi DeryCraft light_postgres provasinda gecici olarak pasif.",
      },
      { status: 503 },
    );
  }
