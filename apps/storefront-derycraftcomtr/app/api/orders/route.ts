...
function requirePrivateOrdersAccess(request: NextRequest) {
    ...
    return NextResponse.json(
        {
            ...
            error: "DeryCraft light_postgres provasinda bu orders endpoint'i yalnizca ic otomasyon icin aciktir.",
        },
        { status: 403 }
    );
}
...
export async function GET(request: NextRequest) {
    const accessResponse = requirePrivateOrdersAccess(request);
    if (accessResponse) {
