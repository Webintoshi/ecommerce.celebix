      ...
      <AnimatePresence>
        {isOpen ? (
          <motion.button
            ...
            className="fixed inset-0 z-40 bg-neutral-950/55 backdrop-blur-[3px]"
      ...
      <AnimatePresence>
        {isOpen ? (
          <motion.div
            ...
            className="relative z-[60] border-t border-neutral-200/80 bg-white shadow-[0_28px_80px_rgba(15,23,42,0.12)]"
            role="dialog"
            aria-modal="true"
              ...
              <div className="mx-auto max-w-3xl">
                <div className="mb-5 flex items-center justify-between gap-4">
                  ...
                  <button
                    type="button"
                    onClick={onClose}
                    className="group inline-flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.16em] text-neutral-500 transition-colors hover:text-neutral-900"
                    aria-label={copy.close}
                  >
                ...
                >
                  ...
                  {query ? (
                    <button
                      type="button"
                      onClick={() => setQuery("")}
                      className="shrink-0 text-[10px] font-medium uppercase tracking-[0.14em] text-neutral-400 transition-colors hover:text-neutral-800"
                    >
                      {copy.clear}
                    </button>
                  ) : null}
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {popularItems.map((term) => (
                        <button
                          ...
                          className="rounded-full border border-neutral-200 bg-neutral-50 px-4 py-2 font-sans text-[12px] text-neutral-700 transition-colors hover:border-[#8B6914]/40 hover:bg-white hover:text-neutral-900"
                        >
                          {term}
                        </button>
                      ))}
