export const checkoutFieldClass =
  "w-full h-12 px-4 rounded-lg border border-[#E8DFD3] bg-white text-[#12100D] text-base placeholder:text-neutral-400 transition-colors focus:border-[#8A6B37] focus:outline-none focus:ring-2 focus:ring-[#8A6B37]/15 disabled:bg-[#FAF7F2] disabled:text-neutral-500 sm:text-sm";
