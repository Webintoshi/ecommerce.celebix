...
import { extractAdminStoredAssetUrl } from "@/lib/asset-url";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const resolvedSource = extractAdminStoredAssetUrl(storeInfo?.faviconUrl);
    ...
    console.error("Failed to serve admin favicon:", error);
  }
