...
function DesktopTopbar({
  ...
  return (
    <header className="sticky top-4 z-30 mx-auto mb-4 hidden w-full max-w-[1560px] md:block">
      <div className="rounded-[22px] border border-[var(--admin-border)] bg-[rgba(255,255,255,0.94)] px-4 py-3 shadow-[0_16px_34px_rgba(17,24,39,0.055)] backdrop-blur-xl xl:px-5">
        ...
        {isDashboardRoot ? (
          <div
            ...
            className="mt-3 flex min-w-0 justify-end border-t border-[rgba(226,231,238,0.72)] pt-3"
          />
        ) : null}
      </div>
    </header>
