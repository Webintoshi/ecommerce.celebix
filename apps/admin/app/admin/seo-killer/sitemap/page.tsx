...
function LinkPanel({ label, href }: { label: string; href: string }) {
  return (
    ...
    >
      ...
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--admin-border)] bg-[#FCFDFE] text-[#8a6f5d] transition-colors group-hover:text-[var(--admin-accent-hover)]">
