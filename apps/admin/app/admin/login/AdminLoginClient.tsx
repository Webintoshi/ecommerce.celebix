...
type AdminLoginClientProps = {
  logtoSignInPath: string | null;
};

export default function AdminLoginClient({ logtoSignInPath }: AdminLoginClientProps) {
  ...
  const logtoHref = logtoSignInPath ? `${logtoSignInPath}?next=${encodeURIComponent(nextPath)}` : null;
            ...
            <div className="mt-6">
              <div className="relative mb-4">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-wide">
                  <span className="bg-white px-3 text-gray-400">Pilot Auth</span>
                </div>
              </div>

              <a
                href={logtoHref}
                className="w-full py-3.5 rounded-xl font-medium text-neutral-900 border border-gray-200 hover:border-neutral-300 hover:bg-gray-50 transition-all inline-flex items-center justify-center"
              >
                Logto ile giriş yap
              </a>
            </div>
