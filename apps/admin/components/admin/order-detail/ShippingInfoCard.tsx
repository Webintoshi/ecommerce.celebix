      ...
      <div className="flex items-center justify-between border-b border-[var(--admin-border)] bg-gradient-to-r from-[#fffaf5] to-white px-5 py-4">
        ...
        {onTrackingUpdate && !isEditing && (
          <button
            ...
            className="rounded-xl p-2 text-stone-400 transition-colors hover:bg-white hover:text-[var(--admin-accent-hover)]"
            title="Düzenle"
          >
            ...
            {isEditing ? (
              <div className="space-y-2">
                <select
                  ...
                  className="w-full rounded-2xl border border-[#e1d2c3] bg-white px-3 py-2.5 text-sm text-stone-700 focus:border-[var(--admin-accent)] focus:outline-none focus:ring-4 focus:ring-[var(--admin-accent)]/15"
                >
                ...
                <div className="flex gap-2">
                  <button
                    onClick={handleSave}
                    disabled={isUpdating}
                    className="flex flex-1 items-center justify-center gap-1 rounded-2xl bg-gradient-to-r from-[#FF6A00] to-[#d95a00] px-3 py-2.5 text-xs font-semibold text-white transition-all hover:from-[#f56a12] hover:to-[#c94d00] disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="rounded-2xl border border-[#e1d2c3] bg-white px-3 py-2.5 text-xs font-semibold text-stone-700 transition-colors hover:bg-[#FCFDFE]"
                  >
                    <X className="w-3 h-3" />
                  </button>
                </div>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  <code className="rounded-xl border border-[var(--admin-border)] bg-white px-2.5 py-1 font-mono text-sm text-stone-700">{trackingNumber}</code>
                  {trackingUrl && (
                    <a
                      href={trackingUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="rounded-xl p-1.5 text-[var(--admin-accent-hover)] transition-colors hover:bg-white"
                      title="Kargo Takip"
                    >
