        ...
        <div className="space-y-6 xl:col-span-2">
          ...
          <div className="space-y-2 rounded-[12px] border border-[var(--admin-border)] bg-white p-5 shadow-sm">
            ...
            <textarea
              ...
              rows={4}
              className={cn(
                "w-full resize-none rounded-[8px] border bg-[#FCFDFE] px-4 py-3 outline-none transition-all focus:border-[var(--admin-accent)] focus:bg-white focus:ring-2 focus:ring-[var(--admin-accent)]/20",
          ...
          <div className="space-y-2 rounded-[12px] border border-[var(--admin-border)] bg-white p-5 shadow-sm">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-[8px] border border-[#e8dbcf] bg-[#FCFDFE] py-3 pl-11 pr-4 outline-none transition-all focus:border-[var(--admin-accent)] focus:bg-white focus:ring-2 focus:ring-[var(--admin-accent)]/20"
              />
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[12px] border border-[var(--admin-border)] bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-2">
              {checks.map((check) => (
                <div key={check.id} className="flex items-center gap-2 rounded-[8px] border border-[var(--admin-border)] bg-white px-3 py-2 text-sm">
