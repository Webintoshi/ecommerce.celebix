...
export default async function ShippingPage() {
  ...
  const cards = [
    ...
    {
      title: "Teslimat",
      text: "Kargo süreleri şehir, yoğunluk ve resmi tatil etkilerine göre değişebilir. Güncel durum sipariş akışı ve bildirimlerle desteklenir.",
      icon: Truck,
    },
    {
      title: "Destek",
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="rounded-[32px] border border-black/5 bg-[#FBF8F4] p-6 shadow-[0_24px_60px_-44px_rgba(41,24,15,0.35)]">
            ...
            <ul className="mt-4 space-y-4 text-sm leading-7 text-[#5F5147]">
              ...
              <li>Teslimat hızı; lokasyon, kargo firması yoğunluğu ve resmi tatil takvimine bağlı olarak değişebilir.</li>
