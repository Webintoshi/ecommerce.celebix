...
const storefrontRepository = { getPublicStorefront: async () => { throw new Error("unused"); }, listPublicProducts: async () => ({ items: [] }), listPublicProductsByCategory: async () => { throw new Error("unused"); }, getPublicProductBySlug: async () => { throw new Error("unused"); }, listPublicProductMedia: async () => [] };
