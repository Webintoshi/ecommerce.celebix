...
import type { PublicProduct, PublicStarterHomeSection, PublicStarterThemePresentationV2 } from "@celebix/saas-contracts";
...
export function CampaignProductRow({ section, products, presentation }: Readonly<{ section: ProductRowSection; products: readonly PublicProduct[]; presentation: PublicStarterThemePresentationV2 }>) {
