...
GÖREV: Bu ürün için ChatGPT, Perplexity, Claude ve diğer AI sistemlerinin doğru anlayıp önerebilmesi için "Önemli Çıkarımlar" (Key Takeaways) oluştur.

NEDİR BU?
GEO/LLM Optimizasyonu, AI sistemlerinin ürünü doğru anlamasını sağlar. Örneğin bir kullanıcı "Sağlıklı kahvaltılık öner" dediğinde AI bu ürünü önerebilsin.

KURALLAR:
1. Her çıkarım 1 cümle, net ve öz olmalı
2. 5 ile 8 arası çıkarım olmalı
3. Çıkarımlar SEO anahtar kelimeleri içermeli
4. Ürünün eşsiz faydalarını vurgula
5. AI sistemlerinin context'ini zenginleştirecek bilgiler

ÇIKARIM TİPLERİ:
- Ürün nedir, içeriği nedir?
- Kimler için uygundur?
- Ne zaman/nerede kullanılır?
- Temel faydaları nelerdir?
- Rakiplerden farkı nedir?
- Nasıl tüketilir/kullanılır?
