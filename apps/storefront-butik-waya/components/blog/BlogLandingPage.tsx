...
export function BlogLandingPage({
  ...
  const description = activeCategory
    ...
    : `${profile.name} tarafından yayınlanan blog yazıları, koleksiyon hikâyeleri ve karar sürecini kolaylaştıran editör notları burada toplanır.`;
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-12 px-6 py-16 lg:px-8 lg:py-20">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-[24px] border border-black/5 bg-white/80 px-5 py-4 shadow-[0_24px_60px_-48px_rgba(24,17,11,0.45)] backdrop-blur">
              <p className="text-xs uppercase tracking-[0.32em] text-[#222222]">Yazı Sayısı</p>
        ...
        {posts.length === 0 ? (
          <div className="rounded-[32px] border border-dashed border-black/10 bg-white/70 px-8 py-20 text-center shadow-[0_24px_80px_-58px_rgba(24,17,11,0.35)]">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-[#222222]">
              Blog yazıları admin panelinde yayınlandığında bu alan otomatik dolar. İlk yazı yayınlandığında kategori ve editorial akışı da beraber gelir.
            </p>
            ...
            {archivePosts.length > 0 ? (
              <div className="space-y-8">
                <div className="flex items-end justify-between gap-6">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.34em] text-[#222222]">Arşiv</p>
                    <h2 className="mt-3 font-serif text-4xl tracking-[-0.05em] text-[#222222]">Daha fazla yazı</h2>
                  </div>
