...
export function ComplementaryProducts({ title, products, loading }: ComplementaryProductsProps) {
      ...
      <section className="py-16 bg-[#ffffff]">
        <div className="container-premium">
          <div className="flex items-center justify-between mb-8">
            <div className="h-8 w-64 bg-[#ffffff] rounded-lg animate-pulse" />
            <div className="h-6 w-24 bg-[#ffffff] rounded-lg animate-pulse" />
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="aspect-[3/4] bg-[#ffffff] rounded-2xl animate-pulse"
              />
            ))}
          </div>
        </div>
  ...
  return (
    <section className="py-16 bg-[#ffffff] border-y border-[#7B1113]/10">
      <div className="container-premium">
        <div className="flex items-center justify-between mb-8">
