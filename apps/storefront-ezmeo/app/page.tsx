...
const HOME_UI_COPY = {
  ...
  productGroups: [
    { title: "Cok satan ezmeler", subtitle: "Hizli secim" },
    { title: "Kahvalti seckisi", subtitle: "Sabah ritmi" },
    { title: "Sekersiz cizgi", subtitle: "Temiz tercih" },
    { title: "Yeni favoriler", subtitle: "Secili kavanozlar" },
  ],
  storesEyebrow: "Ezmeo standardi",
  storesHeading: "Daha temiz arka plan, daha guclu urun odagi.",
  storesDescription:
    "Ezmeo vitrini, bagiran promosyon bloklari yerine kavanozun etiketi, lezzet profili ve gunluk kullanim hissi etrafinda kurulur.",
