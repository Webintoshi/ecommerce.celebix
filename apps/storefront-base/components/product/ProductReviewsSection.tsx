    ...
    <section className="space-y-8 border-t border-[#7B1113]/10 pt-8">
      <div className="space-y-3">
        <div>
          ...
          <h2 className="mt-2 text-2xl tracking-tight text-[#7B1113]">Musteri yorumlari</h2>
        </div>
        <div className="flex flex-wrap items-center gap-3 text-sm text-[#6b4b4c]">
          ...
          <span className="font-medium text-[#7B1113]">{summary.rating.toFixed(1)}</span>
          <span aria-hidden="true" className="text-[#7B1113]/30">•</span>
