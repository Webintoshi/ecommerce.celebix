              ...
              <div key={option.value}>
                ...
                <Label
                  ...
                  className={cn(
                    ...
                    "peer-data-[state=checked]:border-[#22C55E] peer-data-[state=checked]:bg-[#22C55E]/10",
          ...
          >
            {step.options?.map((option) => (
              ...
              >
                ...
                {value === option.value && (
                  <div className="absolute right-1.5 top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-[#16A34A]">
