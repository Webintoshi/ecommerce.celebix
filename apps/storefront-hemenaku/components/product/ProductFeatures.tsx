  ...
  return (
    <div className="space-y-12">
      {descriptionHtml ? (
        ...
        <div className="rounded-lg border border-[#D7DEE8] bg-[#F8FAFC] p-4 text-sm leading-7 text-[#526176]">
          Ürün açıklaması hazırlanıyor. Uyumluluk veya teknik detaylar için Hemenaku destek kanalından bilgi alabilirsiniz.
        </div>
      )}
    </div>
  );
