              ...
              {isMenuOpen ? (
                <>
                  <motion.div
                    ...
                    className="fixed inset-0 z-[9998] bg-[#0B0F14]/55 backdrop-blur-[2px] lg:hidden"
                  ...
                  <motion.aside
                    ...
                    className="fixed inset-y-0 left-0 z-[9999] flex w-[min(92vw,24rem)] max-w-full flex-col overflow-hidden bg-[#F8FAFC] shadow-[0_24px_80px_rgba(15,23,42,0.18)] lg:hidden"
                    role="dialog"
                    aria-modal="true"
