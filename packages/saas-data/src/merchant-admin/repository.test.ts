...
test("typed settings accept only finite public configuration before SQL",async()=>{
 const configurations={
  ...
  category_showcase:{heading:"Koleksiyonları keşfedin",enabled:true,layout:"duo",items:[{categoryId:"81000000-0000-4000-8000-000000000001",assetId:"82000000-0000-4000-8000-000000000001"}]},
 } as const;
 ...
 for(const hostile of [
  {heading:"Kategoriler",enabled:true,items:[{categoryId:RECORD,assetId:RECORD}]},
  {heading:"Kategoriler",enabled:true,layout:"carousel",items:[{categoryId:RECORD,assetId:RECORD}]},
  {heading:"Kategoriler",enabled:true,layout:"grid",items:[]},
  {heading:"Kategoriler",enabled:true,layout:"grid",items:[{categoryId:RECORD,assetId:RECORD},{categoryId:RECORD,assetId:"82000000-0000-4000-8000-000000000002"}]},
  {heading:"Kategoriler",enabled:true,layout:"grid",items:[{categoryId:RECORD,assetId:RECORD},{categoryId:"81000000-0000-4000-8000-000000000002",assetId:RECORD}]},
  {heading:"Kategoriler",enabled:true,layout:"grid",items:[{categoryId:"not-a-uuid",assetId:RECORD}]},
