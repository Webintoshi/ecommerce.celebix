...
const ROLE_ACTIONS: Readonly<Record<StoreMembershipRole, ReadonlySet<MerchantAction>>> = Object.freeze({
  ...
  editor: new Set<MerchantAction>(["orders.read", "orders.fulfill", "orders.note", "quick_links.read", "carts.read", "customers.read", "customers.manage"]),
  analyst: new Set<MerchantAction>(["orders.read", "quick_links.read", "carts.read", "customers.read"]),
});
