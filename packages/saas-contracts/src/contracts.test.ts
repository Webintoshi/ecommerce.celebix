...
test("keeps the public runtime export surface frozen", () => {
  assert.deepEqual(Object.keys(contracts).sort(), [
    ...
    "PRODUCT_STATUSES",
    "PROMOTION_ADMIN_EFFECTIVE_STATUSES",
    ...
    "STORE_DOMAIN_REPLACEMENT_STATUSES",
    "STORE_DOMAIN_TYPES",
    "STORE_DOMAIN_UI_STATUSES",
    "STORE_HOST_STATUSES",
    ...
    "parseEffectivePrice",
    "parseInStoreBootstrap",
    "parseInStoreDiscount",
    "parseInStoreInteger",
    "parseInStoreProduct",
    "parseInStoreSale",
    "parseInStoreSaleIntent",
    "parseInStoreSalePage",
    "parseInStoreSaleResult",
    "parseInStoreStaffGrant",
    "parseInStoreUuid",
...
test("contract sources import no runtime application code", async () => {
  const sourceFiles = [
    ...
    "barcode-labels/index.ts",
    "barcode-labels/types.ts",
    "barcode-labels/validation.ts",
    "promotions/index.ts",
    "promotions/admin.ts",
    "promotions/types.ts",
    ...
    "deletion/index.ts",
    "deletion/types.ts",
    "deletion/validation.ts",
    "inventory/index.ts",
    "inventory/types.ts",
    "inventory/validation.ts",
    "shipping/index.ts",
    "shipping/types.ts",
    "shipping/validation.ts",
    "pricing/index.ts",
    "toshi/providers.ts",
    "pricing/types.ts",
    ...
    "storefront-identity/index.ts",
    "storefront-identity/types.ts",
    "storefront-identity/validation.ts",
  ];
