...
export type {
  ...
  StoreDomainMutationResult,
  StoreDomainReplacementStatus,
  StoreDomainReplacementView,
  StoreDomainView,
...
export type {
  ...
  CatalogCategoryImageFields,
  CatalogCategoryOrderFields,
  CatalogCategoryOrderGroup,
