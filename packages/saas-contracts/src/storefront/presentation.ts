...
export function buildDefaultStarterPresentation(
  ...
  return Object.freeze({
    ...
    theme,
    hero,
    visual: Object.freeze({ colorScheme: "neutral", headingStyle: "serif", cornerStyle: "soft", headerStyle: "overlay", productCardStyle: "editorial", productImageRatio: "portrait", headerWidth: "wide", headerLayout: "menu_logo_actions", sectionSpacing: "balanced" }),
...
export function adaptStarterPresentationV2(value: unknown): PublicStarterThemePresentationV3 {
  ...
  return Object.freeze({
    ...
    visual: Object.freeze({ ...campaign.visual, headerWidth: "wide", headerLayout: "menu_logo_actions", sectionSpacing: "balanced" }),
