...
export function buildDefaultStarterPresentation(
  ...
  return Object.freeze({
    ...
    theme,
    hero,
    visual: Object.freeze({ colorScheme: "neutral", headingStyle: "serif", cornerStyle: "soft", headerStyle: "overlay", productCardStyle: "editorial", productImageRatio: "portrait", headerWidth: "wide", sectionSpacing: "balanced", logoSize: "medium", logoAlignment: "center", headerLayout: "centered" }),
...
export function adaptStarterPresentationV2(value: unknown): PublicStarterThemePresentationV3 {
  ...
  return Object.freeze({
    ...
    visual: Object.freeze({ ...campaign.visual, headerWidth: "wide", sectionSpacing: "balanced", logoSize: "medium", logoAlignment: "center", headerLayout: "centered" }),
