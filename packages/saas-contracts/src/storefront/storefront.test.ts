...
test("starter presentation defaults and token mapping are deterministic and bounded", () => {
  ...
  assert.deepEqual(defaults, {
    ...
    visual: { colorScheme: "neutral", headingStyle: "serif", cornerStyle: "soft", headerStyle: "overlay", productCardStyle: "editorial", productImageRatio: "portrait", headerWidth: "wide", sectionSpacing: "balanced", logoSize: "medium", logoAlignment: "center" },
    navigation: { items: [] },
    sections: [
