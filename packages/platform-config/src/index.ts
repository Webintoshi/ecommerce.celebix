  ...
  const databaseEnvLines =
    config.databaseMode === "full_supabase"
      ...
      : [
          ...
          "# Logto admin auth hazir oldugunda asagidaki provider ve secret keyleri doldurup status'u configured yapin.",
          ...
          "# LOGTO_ISSUER=https://auth.celebix.co/oidc",
          ...
          "# LOGTO_COOKIE_SECRET=configure-random-cookie-secret",
        ];
